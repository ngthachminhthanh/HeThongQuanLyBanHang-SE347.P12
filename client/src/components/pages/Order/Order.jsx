  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (paymentMethod === "cod") {
        ...
        const zalopay_order = await axios.post(
          "https://e4a7-14-169-2-6.ngrok-free.app/api/payment",
          order
        );
    ...
    <>
      <header className="bg-white shadow-md fixed top-0 left-0 right-0">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          <Link
            to="/"
            className="text-2xl font-bold hover:text-pink-700 transition duration-300"
          >
            MERN Shop
          </Link>
